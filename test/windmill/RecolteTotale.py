...
def test_RecolteTotale():
    ...
    client.click(name=u'boutons[next]')
    client.waits.forPageLoad(timeout=u'20000')
    client.waits.forElement(timeout=u'8000', name=u'passer_etape')
    client.click(name=u'passer_etape')
    client.waits.forPageLoad(timeout=u'20000')
    client.waits.forElement(timeout=u'8000', name=u'boutons[next]')
    client.click(name=u'boutons[next]')
    client.waits.forPageLoad(timeout=u'20000')
    ...
    client.asserts.assertText(xpath=u"//div[@id='nouvelle_declaration']/h3", validator=u'Connexion')
