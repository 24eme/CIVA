function(doc) {
	...
	var numero_contrat = doc.numero_visa;
	var daa = null;
	var date_arrivee = (doc.valide.validation).replace("-","");
	var date_traitement = (doc.valide.validation).replace("-","");
	var date_saisie = (doc.valide.validation).replace("-","");
	var date_circulation = (doc.valide.validation).replace("-","");
	var identifiant_courtier = doc.mandataire.num_db2;
	var reccod = null;
