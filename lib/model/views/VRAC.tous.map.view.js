function(doc) {
	...
	if (doc.vendeur_identifiant) {
		...
		emit([doc.vendeur_identifiant, type_contrat, doc.campagne, doc.valide.statut], {soussignes: {vendeur: vendeur, acheteur: acheteur, mandataire: mandataire}, is_proprietaire: is_proprietaire, date: date, statut: statut, numero: numero, numero_visa: numero_visa, etape: etape, type_contrat: type_contrat});
	}
	if (doc.acheteur_identifiant) {
		var is_proprietaire = (doc.acheteur_identifiant == doc.createur_identifiant)? 1 : 0;
		emit([doc.acheteur_identifiant, type_contrat, doc.campagne, doc.valide.statut], {soussignes: {vendeur: vendeur, acheteur: acheteur, mandataire: mandataire}, is_proprietaire: is_proprietaire, date: date, statut: statut, numero: numero, numero_visa: numero_visa, etape: etape, type_contrat: type_contrat});
	}
	if (doc.mandataire_identifiant) {
		var is_proprietaire = (doc.mandataire_identifiant == doc.createur_identifiant)? 1 : 0;
		emit([doc.mandataire_identifiant, type_contrat, doc.campagne, doc.valide.statut], {soussignes: {vendeur: vendeur, acheteur: acheteur, mandataire: mandataire}, is_proprietaire: is_proprietaire, date: date, statut: statut, numero: numero, numero_visa: numero_visa, etape: etape, type_contrat: type_contrat});
	}
}