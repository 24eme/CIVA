...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    uasort($acheteurs_negociant, 'civaConfigGenerateAcheteursTask::sortByNom');
    uasort($acheteurs_cave, 'civaConfigGenerateAcheteursTask::sortByNom');
    uasort($acheteurs_mout, 'civaConfigGenerateAcheteursTask::sortByNom');
