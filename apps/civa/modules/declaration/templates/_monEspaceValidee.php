...
<div class="contenu_section">
    ...
    <div class="ligne_form ligne_btn">
        ...
        <?php if ($sf_user->hasCredential(myUser::CREDENTIAL_ADMIN) && $sf_user->getDeclaration()->isValideeCiva()): ?>
        ...
        <?php endif; ?>
        <?php if ($sf_user->hasCredential(myUser::CREDENTIAL_ADMIN) && $sf_user->getDeclaration()->isValideeTiers()): ?>
