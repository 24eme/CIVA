<ul id="btn_etape" class="btn_prev_suiv clearfix">
    ...
    <li class="prec"><a href="<?php echo url_for('@exploitation_lieu') ?>?from_recolte=1" class="<?php if ($inactif): ?>btn_inactif<?php endif; ?>"><img src="/images/boutons/btn_retourner_etape_prec.png" alt="Retourner à l'étape précédente" /></a></li>
