			...
			<!--<form id="principal" action="<?php // echo url_for('@recolte'); ?>" method="post">-->
				...
				<div id="application_dr" class="clearfix">
					...
					<ul id="btn_appelation" class="btn_prev_suiv clearfix">
                                                ...
                                                <?php endif; ?>
						<li class="suiv"><a href="<?php echo url_for($onglets->getUrlRecap(true)->getRawValue()) ?>"><img src="/images/boutons/btn_appelation_suiv.png" alt="Valider et Passer à l'appelation suivante" /></a></li>
					</ul>
