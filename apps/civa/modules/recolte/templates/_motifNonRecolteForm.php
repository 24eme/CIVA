...
<?php echo jq_form_remote_tag(array('url' => url_for(array_merge($onglets->getUrl('recolte_motif_non_recolte', null, null, null, null, null)->getRawValue(), array('detail_key' => $detail_key))),
                                    'method' => 'post',
                                    'dataType' => 'json',
