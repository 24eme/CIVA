...
<div id="col_cepage_total" class="col_recolte col_total" style="<?php if (!$cepage->hasTotalCepage()): ?>display:none;<?php endif; ?>">
   ...
   <ul class="vol_revendique_dplc">
    <li class="rendement <?php if ($cepage->getTotalDPLC()) echo 'alerte'; ?>">Rdt : <strong><span id="cepage_current_rendement"><?php echoFloat($cepage->getRendementRecoltant()); ?></span> hl/ha</strong><span><a href="" class="msg_aide" rel="help_popup_DR_total_cepage" title="Message aide">Test message d'aide</a></span></li>
