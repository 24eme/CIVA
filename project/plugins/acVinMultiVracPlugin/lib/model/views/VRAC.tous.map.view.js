function(doc) {
  ...
  if(doc.contrat_pluriannuel && doc.reference_contrat_pluriannuel) {
	...
	if (doc.vendeur_identifiant) {
		...
		emit([doc.vendeur_identifiant, type_contrat, doc.campagne, doc.valide.statut], {role: "vendeur", soussignes: {vendeur: vendeur, acheteur: acheteur, mandataire: mandataire}, is_proprietaire: is_proprietaire, date: date, statut: statut, numero: numero, numero_visa: numero_visa, etape: etape, type_contrat: type_contrat, papier: papier, commercial: commercial, pluriannuel: pluriannuel, reference_pluriannuel: reference_pluriannuel, campagne: doc.campagne, temporalite: temporalite});
	}
