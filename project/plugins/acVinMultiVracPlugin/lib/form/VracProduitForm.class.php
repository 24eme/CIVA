...
class VracProduitForm extends acCouchdbObjectForm
{
   	public function configure()
    {
        ...
        if(!$this->getObject()->getDocument()->isPluriannuelCadre() && $this->getObject()->getDocument()->type_contrat == VracClient::TYPE_VRAC
            && (strpos($this->getObject()->getHash(), 'cepage_PG') !== false || strpos($this->getObject()->getHash(), 'cepage_GW') !== false)
        ) {
    ...
    {
      return array('' => '', 'AUCUNE' => 'Aucune', VracClient::LABEL_BIO => 'Bio', VracClient::LABEL_HVE => 'HVE3', VracClient::LABEL_BIO_HVE => 'Bio & HVE3');
    }
    ...
    public function doUpdateObject($values) {
        ...
        if (array_key_exists('label', $values) && $values['label'] === "AUCUNE") {
