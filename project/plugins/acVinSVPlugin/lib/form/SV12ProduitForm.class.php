...
class SV12ProduitForm extends acCouchdbObjectForm
{
    ...
    public function configure() {
        $this->setWidget('superficie_recolte', new bsWidgetFormInputFloat(array(), array('class' => 'form-control text-right input-float input-sm')));
        ...
        $this->setWidget('volume_revendique', new bsWidgetFormInputFloat(array(), array('placeholder' => '', 'class' => 'form-control text-right input-float input-sm input_volume_revendique')));
