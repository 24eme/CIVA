...
class SV11ProduitForm extends acCouchdbObjectForm
{
    ...
    public function configure() {
        ...
        $this->setWidget('volume_detruit', new bsWidgetFormInputFloat(array(), ['placeholder' => 'hl', 'class' => 'form-control text-right input-float input-sm input_volume_revendique', 'disabled' => $this->getObject()->isRebeche()]));
        $this->setValidator('volume_detruit', new sfValidatorNumber(array('required' => false)));

        $this->setWidget('vci', new bsWidgetFormInputFloat(array(), ['placeholder' => 'hl', 'class' => 'form-control text-right input-float input-sm input_volume_revendique', 'disabled' => $this->getObject()->isRebeche()]));
