<table class="table table-bordered table-striped">
  ...
  <?php $produit = $sv->get($hash); ?>
    <tr class="vertical-center">
      ...
      <td style="position: relative;" class="text-center"><a title="Paramètrer les taux d'extraction globaux" href="<?php echo url_for('sv_saisie', array('sf_subject' => $sv, 'cvi' => $cvi, 'parametrage_extraction' => 1)) ?>" style="position: absolute; right: 50%; top: 50%; transform: translate(50%,-50%); opacity: 0.3;" tabindex="-1" class="lien_parametrage <?php if($formProduit['taux_extraction']->getValue()): ?>hidden<?php endif; ?>"><span class="glyphicon glyphicon-cog"></span></a><?php echo $formProduit['taux_extraction']->render(array('style' => "background: transparent; border: none; box-shadow: none;", 'data-config' => $produit->getTauxExtractionDefault())) ?></td>
    </tr>
  <?php endforeach ?>
  </tbody>
</table>
