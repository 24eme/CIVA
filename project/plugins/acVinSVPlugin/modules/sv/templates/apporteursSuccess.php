...
<div class="alert alert-warning pointer">
  <a href="<?php echo url_for('sv_apporteurs', array('sf_subject' => $sv, 'parametrage_extraction' => 1)) ?>" class="btn btn-link btn-xs pull-right"><span class="glyphicon glyphicon-cog"></span> Paramétrer les taux d'extraction globaux</a>
