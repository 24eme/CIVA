...
<table class="table table-bordered table-striped">
  ...
  <?php $produit = $sv->get($hash); ?>
    <tr class="vertical-center">
      ...
      <td><?php echo $produit->getRawValue()->getLibelleHtml() ?></td>
      <td></td>
      <td><?php echoFloat($produit->volume_mouts) ?> <small class="text-muted">hl</small></td>
      ...
      <td><?php echoFloat($produit->superficie_mouts) ?> <small class="text-muted">ares</small></td>
    </tr>
  <?php endforeach ?>
  </tbody>
</table>
