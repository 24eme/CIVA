...
<nav class="navbar navbar-default nav-step">
    ...
    <?php foreach ($etapes->getEtapesHash() as $k => $num):
      ?>
        ...
        <li style="<?php if($disabled): ?>opacity: 0.5;<?php endif; ?>" class="<?php if($actif): ?>active<?php endif; ?> <?php if ((!$past && !$actif) || $disabled): ?>disabled<?php endif; ?> <?php if ($past && !$actif && !$disabled): ?>visited<?php endif; ?>">
                <a href="<?php
