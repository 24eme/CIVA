...
<div id="popup_confirme_mail" class="popup_ajout" title="Confirmation d'envoi de mail de votre DR">
    <form method="post" action="">
        <p>
            Confirmez vous l'envoi par mail de votre déclaration de récolte ? <br />
        </p>
        <div id="btns">
            <br /s>
...
<div style="display: none" id="popup_loader_send" title="Envoie du PDF">
    <div class="popup-loading">
        <p>L'envoi par e-mail de votre DR est en cours.<br/>Merci de patienter.<br/><small>La procédure peut prendre 30 secondes</small></p>
    </div>
</div>