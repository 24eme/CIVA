<ul id="liste_sepages">
    ...
    <li class="recapitulatif <?php if ($recapitulatif): ?> ui-tabs-selected<?php endif; ?>" ><a href="<?php echo url_for($onglets->getUrlRecap()->getRawValue()) ?>">Recap. des<br />Ventes&nbsp;et<br />Us.&nbsp;industriels<span></span></a></li>
</ul>