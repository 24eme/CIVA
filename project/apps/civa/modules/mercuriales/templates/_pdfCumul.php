...
<table border="0" cellspacing=0 cellpadding="0">
		...
		<tr>
			<th style="text-align: center; border-left: 1px solid black; width: 23%"><strong><?php echo strtoupper($bio_ou_conv); ?></strong></th>
	...
	<table border="0" cellspacing=0 cellpadding="10">
		<?php
		  $stats = $mercuriale->getCumul(false, $isbio);
		  $volCur = 0;
		  $volPrev = 0;
		...
		?>
		<tr>
			<td style="text-align: left; border-left: 1px solid black; border-bottom: 1px solid black; width: 23%"><?php echo strtoupper($stat[VracMercuriale::OUT_CP_LIBELLE]) ?> <span style="font-size: 80%;"><?php echo $bio_ou_conv; ?></span></td>
	...
	<table border="0" cellspacing=0 cellpadding="10">
		<tr>
			<td style=" width: 23%; text-align: left; border-left: 1px solid black; border-bottom: 1px solid black; border-top: 1px solid black;"><strong>TOTAL <span style="font-size: 80%;"><?php echo strtoupper($bio_ou_conv); ?></span></strong></td>
			...
			<td style=" width: 11%; text-align: right; border-bottom: 1px solid black; border-top: 1px solid black;"><strong><?php echo printdiffratio($volCur - $volPrev, $volPrev); ?></strong></td>
    ...
    <table border="0" cellspacing=0 cellpadding="10">
		<tr>
			...
			<td style=" width: 11%; text-align: right; border-bottom: 1px solid black; border-top: 1px solid black;"><strong><?php echo printdiffratio($stats[VracMercuriale::OUT_STATS][VracMercuriale::OUT_VARIATION][VracMercuriale::OUT_CONTRAT], $stats[VracMercuriale::OUT_STATS][VracMercuriale::OUT_PREVIOUS][VracMercuriale::OUT_CONTRAT]); ?></strong></td>
			<td style=" width: 11%; text-align: right; border-right: 1px solid black; border-bottom: 1px solid black; border-top: 1px solid black;"></td>
		</tr>
		<tr>
			...
			<td style=" width: 11%; text-align: right; border-bottom: 1px solid black;"><strong><?php echo printdiffratio($stats[VracMercuriale::OUT_STATS][VracMercuriale::OUT_VARIATION][VracMercuriale::OUT_NB], $stats[VracMercuriale::OUT_STATS][VracMercuriale::OUT_PREVIOUS][VracMercuriale::OUT_NB]); ?></strong></td>
