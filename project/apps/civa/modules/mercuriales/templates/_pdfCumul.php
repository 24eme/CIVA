...
<table border="0" cellspacing=0 cellpadding="0">
	...
	<table border="0" cellspacing=0 cellpadding="10">
		<tr>
			...
			<td style=" width: 12%; text-align: right; border-bottom: 1px solid black; border-top: 1px solid black;"><strong><?php echo (round(($volCur - $volPrev) / $volPrev * 100) > 0)? "+".number_format(round(($volCur - $volPrev) / $volPrev * 100), 2, ',', '.') : number_format(round(($volCur - $volPrev) / $volPrev * 100), 2, ',', '.') ?></strong></td>
