...
<a class="btn_majeur btn_petit btn_vert" href="<?php echo url_for('ds_export_pdf_empty', array('cvi' => $sf_user->getDeclarant()->getIdentifiant())); ?>" style="float: left; margin-top: 20px;">Télécharger mon brouillon</a>
