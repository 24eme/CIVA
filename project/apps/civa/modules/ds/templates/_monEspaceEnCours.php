...
<form id="form_ds" action="<?php echo url_for('ds_init', $ds) ?>" method="post">
    ...
    <div class="contenu_section">    
        ...
        <a class="btn_majeur btn_petit btn_jaune" href="<?php echo url_for('ds_export_pdf_empty', array('cvi' => $sf_user->getDeclarant()->getIdentifiant())); ?>" style="margin-top: 20px;">Télécharger mon brouillon</a>
        <?php endif; ?>
    </div>
</form>
