...
<?php elseif(!$sf_user->hasCredential(myUser::CREDENTIAL_OPERATEUR) && $sf_user->isDsTerminee()): ?>
    <?php include_partial('ds/monEspaceNonEditable',array('ds' => $ds, 'type_ds' => $type_ds)); ?>
<?php elseif(!$sf_user->hasCredential(myUser::CREDENTIAL_OPERATEUR) && $sf_user->isDsNonOuverte()): ?>
