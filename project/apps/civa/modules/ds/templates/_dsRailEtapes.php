...
<div class="header_ds clearfix <?php if(($etape==3) && ($many_lieux || $ds_principale->isAjoutLieuxDeStockage())) echo "sous_menu"; ?>">
	...
	<div class="progression_ds">
                <p>Vous avez saisi <span><?php echo $progression.'%';?></span> de votre DS <a href="" class="msg_aide_ds" rel="help_popup_mon_espace_ds_general<?php if($ds_principale->type_ds == DSCivaClient::TYPE_DS_NEGOCE): ?>_negoce<?php endif; ?>" title="Message aide"></a></p>
