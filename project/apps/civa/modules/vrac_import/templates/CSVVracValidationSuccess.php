                ...
                <table id="table_contrat" class="table table-bordered table-condensed table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if ($contrat['id']): ?>
                                <a class="pull-left btn btn-link btn-sm" style="padding:0;" href="<?php echo url_for('vrac_fiche', ['numero_contrat' => substr($contrat['id'], 5)]) ?>">Visualiser le projet de contrat</a>
                            <?php endif; ?>
                        </td>
                        <td>
