...
<div id="documents_aide">
	...
	<div class="contenu_section">
	    <ul>
	        <li><a href="<?php //echo url_for('dr_telecharger_la_notice') ?>" class="pdf" style="cursor: not-allowed; opacity: 0.5;">Télécharger&nbsp;la&nbsp;notice&nbsp;Récolte <small>(en cours d'élaboration)</small></a></li>
	        <li><a href="<?php echo url_for('dr_telecharger_guide_vci') ?>" class="pdf">Télécharger le guide du VCI</a></li>
          <li><a href="/drm/doc/docs/Fonctionnement_VCI_2020_2021.pdf" class="pdf">Fonctionnement&nbsp;VCI&nbsp;2020-2021</a></li>
	    </ul>
