<form id="principal" action="" method="post">
	...
	<div id="notice_evolutions">
		...
		<div style="font-size: 14px; padding-left: 5px;">
			...
			<p>La gestion des lies peut se faire globalement par appellation <u>ou</u> par cépage (cf écran "Répartition"). Si vous optez pour la gestion par cépage, vous inscrivez vos lies connues dans la ligne "Volume à détruire" et le système vous calculera automatiquement le volume revendiqué par cépage.</p>
		</div>
	</div>
