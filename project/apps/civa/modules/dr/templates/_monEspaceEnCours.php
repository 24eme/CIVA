<form id="form_dr" action="<?php echo url_for('dr_init', array('identifiant' => $etablissement->getIdentifiant(), 'campagne' => $campagne)) ?>" method="post">
    ...
    <div class="contenu_section">
        ...
        <p class="intro msg_mon_espace_civa"><?php echo acCouchdbManager::getClient('Messages')->getMessage('intro_mon_espace_civa_dr_date_limite'); ?></p>
    </div>
</form>
