    ...
    <div class="ligne_form ligne_btn">
        ...
        <?php if ($sf_user->hasCredential(myUser::CREDENTIAL_ADMIN)): ?>
            ...
            <?php if (CurrentClient::getCurrent()->exist('dr_non_editable') && CurrentClient::getCurrent()->dr_non_editable == 0): ?>
                <a href="<?php echo url_for('dr_invalider_recoltant') ?>" onclick="return confirm('Etes-vous sûr de vouloir dévalider cette DR ?')"><img src="/images/boutons/btn_devalider_dr.png" alt="" class="btn" id=""  /></a>
            <?php endif; ?>
        <?php endif; ?>
    </div>
</div>
