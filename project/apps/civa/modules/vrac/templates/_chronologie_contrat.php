...
<table class="validation table_donnees">
	...
	<tbody>
        ...
        <tr>
			<td>
				<span class="picto_crayon" style="padding-left:15px; margin-left: 2px;">&nbsp;Projet de contrat initié par <?php if ($vrac->hasVersion() && $vrac->hasCourtier()): ?>le courtier<?php elseif($vrac->hasVersion()): ?>le vendeur<?php else: ?>l'acheteur<?php endif; ?></span>
			</td>
            <td style="text-align: left;">
				<?php echo format_date($vrac->valide->date_saisie, 'dd/MM/yyyy'); ?>
			</td>
        ...
        <tr>
			<td>
				<span class="picto_check" style="padding-left:15px; margin-left: 2px;">&nbsp;Projet validé par l'acheteur et soumis à l'acheteur</span>
			</td>
            <td style="text-align: left;"><?php echo format_date($vrac->valide->date_saisie, 'dd/MM/yyyy'); ?></td>
		</tr>
        <?php endif; ?>
        <tr>
			<td>
