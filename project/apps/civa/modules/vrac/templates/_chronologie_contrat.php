	...
	<tbody>
        ...
        <tr>
            ...
            <td style="text-align: center;">
                ...
                <?php if($sf_user->hasCredential(CompteSecurityUser::CREDENTIAL_ADMIN)): ?>
                <a href="" onclick="document.getElementById('contenu_mail').innerHTML = this.title; document.getElementById('contenu_mail').style.display = 'block'; return false;" title="<?php echo displayMail(VracMailer::getInstance()->demandeSignature($vrac->getRawValue())); ?>" style="position: absolute; left: 430px; opacity: 0.5;">[voir le mail]</a>
                <?php endif; ?>
            </td>
		</tr>
