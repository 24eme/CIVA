...
<table class="validation table_donnees">
	...
	<tbody>
        ...
        <tr>
			...
			<td class="<?php echo isVersionnerCssClass($vrac, 'vendeur_frais_annexes') ?>">
				<?php echo $vrac->getTauxCvo(); ?> € HT/hl <?php if(is_file(sfConfig::get('sf_web_dir').'/drm/doc/docs/Organisation_du_marche_'.str_replace("-", "_", $vrac->campagne).'.pdf')): ?><small class="noprint" style="font-size: 12px; color: #666; margin-left: 10px;">(<a target="_blank" href="/drm/doc/docs/Organisation_du_marche_<?php echo str_replace("-", "_", $vrac->campagne) ?>.pdf">Organisation du marché <?php echo str_replace("-", "/", $vrac->campagne) ?></a>)</small><?php endif; ?>
			</td>
		</tr>
		<?php endif; ?>
		<?php endif; ?>
