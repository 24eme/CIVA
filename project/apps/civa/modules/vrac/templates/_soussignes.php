		...
		<?php if ($vrac->vendeur_identifiant): $ic = null; ?>
			...
			<?php else: ?>
				<div class="bloc_soussigne<?php if ($user->_id == $vrac->vendeur_identifiant): ?> actif<?php endif; ?>">
					...
					<div class="cadre">
			<?php endif; ?>	
						<?php include_partial('vrac/soussigne', array('tiers' => $vrac->vendeur, 'date_validation' => $vrac->valide->date_validation_vendeur, 'interlocuteur_commercial' => $ic, 'fiche' => $fiche)) ?>
					</div>
				</div>
		<?php endif; ?>
		...
		<?php if ($vrac->acheteur_identifiant): $ic = null; ?>
			...
			<?php else: ?>
				<div class="bloc_soussigne<?php if ($user->_id == $vrac->acheteur_identifiant): ?> actif<?php endif; ?>">
					...
					<div class="cadre">
			<?php endif; ?>
						<?php include_partial('vrac/soussigne', array('tiers' => $vrac->acheteur, 'date_validation' => $vrac->valide->date_validation_acheteur, 'interlocuteur_commercial' => $ic, 'fiche' => $fiche)) ?>
					</div>
				</div>
		<?php endif; ?>
		...
		<?php if ($vrac->mandataire_identifiant): $ic = null; ?>
			...
			<?php else: ?>
				<div class="bloc_soussigne<?php if ($user->_id == $vrac->mandataire_identifiant): ?> actif<?php endif; ?>">
					...
					<div class="cadre">
			<?php endif; ?>
						<?php include_partial('vrac/soussigne', array('tiers' => $vrac->mandataire, 'date_validation' => $vrac->valide->date_validation_mandataire, 'interlocuteur_commercial' => $ic, 'fiche' => $fiche)) ?>
					</div>
				</div>
		<?php endif; ?>
