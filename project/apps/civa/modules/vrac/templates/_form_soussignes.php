		...
		<div class="form_col">
			...
			<div class="nom_cvi ligne_form">
				...
				<div id="vendeur_recoltants" class="ligne_form" data-condition-value="<?php echo AnnuaireClient::ANNUAIRE_RECOLTANTS_KEY ?>">
					...
					<a href="<?php echo url_for('annuaire_selectionner', array('type' => AnnuaireClient::ANNUAIRE_RECOLTANTS_KEY)) ?>">Ajouter à mon carnet d'adresse</a>
				</div>
				<div id="vendeur_negociants" class="ligne_form" data-condition-value="<?php echo AnnuaireClient::ANNUAIRE_NEGOCIANTS_KEY ?>">
					...
					<a href="<?php echo url_for('annuaire_selectionner', array('type' => AnnuaireClient::ANNUAIRE_NEGOCIANTS_KEY)) ?>">Ajouter à mon carnet d'adresse</a>
				</div>
				<div id="vendeur_caves_cooperatives" class="ligne_form" data-condition-value="<?php echo AnnuaireClient::ANNUAIRE_CAVES_COOPERATIVES_KEY ?>">
					...
					<a href="<?php echo url_for('annuaire_selectionner', array('type' => AnnuaireClient::ANNUAIRE_CAVES_COOPERATIVES_KEY)) ?>">Ajouter à mon carnet d'adresse</a>
				</div>
			</div>
		</div>
