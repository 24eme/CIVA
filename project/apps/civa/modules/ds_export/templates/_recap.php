...
<tr>
  ...
  <th style="width: 110px; font-weight: bold; border: 1px solid black; background-color: black; color: white; text-align: right;">Total</th>
  <th style="width: 110px; font-weight: bold; border: 1px solid black; background-color: black; color: white; text-align: right;">hors VT et SGN</th>
  <th style="width: 110px; font-weight: bold; border: 1px solid black; background-color: black; color: white; text-align: right;">VT</th>
  <th style="width: 110px; font-weight: bold; border: 1px solid black; background-color: black; color: white; text-align: right;">SGN</th>
</tr>
<?php foreach($recap_total as $item): ?>
<tr>
  <td style="text-align: left; width: 198px; border: 1px solid black; font-weight: bold; text-align: left;">&nbsp;<?php echo str_replace("TOTAL ", "", $item->nom) ?></td>
