...
<tr>
  <th style="width: 198px; font-weight: bold; border: 1px solid black; background-color: black; color: white; text-align: left;">Appellations</th>
  <th style="width: 110px; font-weight: bold; border: 1px solid black; background-color: black; color: white; text-align: center;">Total</th>
  <th style="width: 110px; font-weight: bold; border: 1px solid black; background-color: black; color: white; text-align: center;">hors VT et SGN</th>
  <th style="width: 110px; font-weight: bold; border: 1px solid black; background-color: black; color: white; text-align: center;">VT</th>
  <th style="width: 110px; font-weight: bold; border: 1px solid black; background-color: black; color: white; text-align: center;">SGN</th>
</tr>
...
<tr>
  ...
  <td style="width: 110px; border: 1px solid black; <?php if(is_null($item->volume_normal)): ?>background-color: #bbb;<?php endif; ?>"><?php echoVolume($item->volume_normal, true) ?></td>
  <td style="width: 110px; border: 1px solid black; <?php if(is_null($item->volume_vt)): ?>background-color: #bbb;<?php endif; ?>"><?php echoVolume($item->volume_vt, true) ?></td>
  <td style="width: 110px; border: 1px solid black; <?php if(is_null($item->volume_sgn)): ?>background-color: #bbb;<?php endif; ?>"><?php echoVolume($item->volume_sgn, true) ?></td>
  <?php else: ?>
...
<tr>
  ...
  <?php else: ?>
    <td style="width: 110px; border: 1px solid black; text-align:center; font-weight: bold;"><i>Néant</i></td>
  <?php endif; ?>
</tr>
</table>
<br />
