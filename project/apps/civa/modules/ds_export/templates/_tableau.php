...
<?php foreach($tableau['produits'] as $produit): ?>
  <tr>
    ...
    <?php if($colonne["rowspan"] > 0): ?>
      <td style="text-align: left; border: 1px solid black; width: <?php echo round(318/count($tableau['colonnes'])) ?>px; <?php if(is_null($colonne['libelle'])): ?>background-color: #bbb;<?php endif; ?>" rowspan="<?php echo $colonne["rowspan"] ?>">&nbsp;<?php echo truncate_text($colonne['libelle'], round(50 / count($tableau['colonnes']))) ?></td>
    <?php endif; ?>
    <?php endforeach; ?>
