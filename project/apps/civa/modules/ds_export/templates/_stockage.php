...
<table style="margin: 0" border="0">
  <tr>
    <td style="width: 420px;">&nbsp;Numéro : <i><?php echo substr($ds->stockage->numero, 0, 10) ?>&nbsp;<b><?php echo substr($ds->stockage->numero, -3) ?></b></i></td>
  ...
  <tr><td colspan="2">&nbsp;Adresse : <i><?php echo truncate_text($ds->stockage->nom.', '.$ds->stockage->adresse. ", ".$ds->stockage->code_postal." ".$ds->stockage->commune, 90, "...", false) ?></i></td></tr>
</table>
</td></tr></table>