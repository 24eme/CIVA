...
Il sera également accessible sur la plateforme du CIVA à l'adresse suivante : <?php echo sfConfig::get('app_base_url').ProjectConfiguration::getAppRouting()->generate('vrac_fiche', array('sf_subject' => $vrac), false); ?>
