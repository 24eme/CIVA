<div class="col_recolte col_active">
    <form action="<?php echo ($is_new) ? url_for('recolte_produit_ajout', array('hash' => $produit->getHash())) : url_for('recolte_produit_edition', array('hash' => $produit->getHash(), 'detail_key' => $detail->getKey())) ?>" method="post" onsubmit="return valider_can_submit();">
