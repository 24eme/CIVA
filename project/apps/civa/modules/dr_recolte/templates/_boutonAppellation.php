<ul id="btn_appelation" class="btn_prev_suiv clearfix">
    <?php $margin = "190px"; ?>
    <li class="prec">
        <a href="<?php echo url_for('dr_recolte_noeud_precedent', array('sf_subject' => $produit, 'hash' => $produit->getMention()->getHash())) ?>" class="btn_recolte_can_be_inactif" <?php if (isset($is_recap) && $is_recap): ?>onclick="document.getElementById('principal').submit(); return false;"<?php endif; ?>>
