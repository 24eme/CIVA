<ul id="onglets_majeurs" class="clearfix">
	...
	<li class="<?php if($active== 'gamma'): ?>ui-tabs-selected<?php endif; ?>"><a href="<?php echo url_for("mon_espace_civa_gamma", array('identifiant' => $compte->getIdentifiant())) ?>">Gamm@</a></li>
	<?php endif; ?>
