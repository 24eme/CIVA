...
<div id="application_dr" class="mon_espace_civa clearfix">
    ...
    <?php include_partial('tiers/onglets', array('active' => 'stock_'.$type_ds)) ?>
     ...
     <div id="espace_alsace_recolte" class="contenu clearfix"> 
        ...
        <?php endif; ?>
        <?php include_component('ds', 'monEspace', array('type_ds' => $type_ds)) ?>
        <?php include_component('ds', 'monEspaceColonne', array('type_ds' => $type_ds)) ?>
    </div>
</div>