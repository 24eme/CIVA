...
MAIL_BODY="Bonjour,\n\nLa Déclaration de Récolte est à télé-déclarer sur le Portail du CIVA.\n\nÀ ce jour nous n'avons pas enregistré de saisie pour la déclaration de Récolte $ANNEE.\n\nNous vous rappelons que vous devez impérativement télé-déclarer votre Récolte AVANT le mardi 10 décembre 23h59.\n\nVous pouvez effectuer la saisie en cliquant sur le lien suivant : https://declaration.vinsalsace.pro/ \n\nCordialement, \n\nLe CIVA"
