...
abstract class CompteForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setValidators(array(
                ...
                'mdp1'  => new sfValidatorString(array('required' => true, "min_length" => "8"), array('required' => 'Champ obligatoire', "min_length" => "Votre mot de passe doit comporter au minimum 8 caractères.")),
