...
Attention la date limite de la télé-déclaration est fixée par la Douane au 10 septembre ".$campagne." MINUIT.

Pour vous aider dans votre démarche vous trouverez ci-joint un brouillon personnalisé de votre DS ".$campagne.", qui reprend les produits théoriquement détenus en stocks, vous pouvez également télécharger la Notice d'Aide au format PDF ou consulter l'aide en ligne.
...
Le téléservice \"Alsace Stocks\" sera accessible dès le 24 juillet, et jusqu'au 10 septembre ".$campagne." inclus.
