...
class importConfiguration2015Task extends sfBaseTask
{
...
EOF;
    ...
    protected function execute($arguments = array(), $options = array())
    {
        ...
        foreach (file(sfConfig::get('sf_data_dir') . '/import/'.$anneeCourte.'/Ceprec'.$anneeCourte) as $a) {
        ...
        $cepcom = array();
        foreach (file(sfConfig::get('sf_data_dir') . '/import/'.$anneeCourte.'/Cepcom'.$anneeCourte) as $l) {
        ...
        foreach (file(sfConfig::get('sf_data_dir') . '/import/'.$anneeCourte.'/Grdcrv'.$anneeCourte) as $l) {
    ...
    public function getCepage($code, $code_depage = null, $qualite = null, $rendement = null)
    {
        ...
        $cepages->cepage_RI->rendement = 80;
