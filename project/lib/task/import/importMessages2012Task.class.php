...
EOF;
	...
	protected function execute($arguments = array(), $options = array())
	{
		...
		$json->err_log_pas_calculer_revendique_sur_place = "Le volume revendiqué sur place ne peut pas être calculé car touts les volumes en dépassement de vos acheteurs n'ont pas été saisi dans le récapitulatif des ventes";
