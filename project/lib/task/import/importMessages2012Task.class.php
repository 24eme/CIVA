...
EOF;
	...
	protected function execute($arguments = array(), $options = array())
	{
		...
		$json->help_popup_mon_espace_civa_ma_ds  = "Vous pouvez saisir votre déclaration de stocks. <br /> 1) Les produits qui s'affichent sont ceux que vous avez déclarés \"sur place\" sur votre dernière déclaration de récolte";
