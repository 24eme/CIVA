...
EOF;
	...
	protected function execute($arguments = array(), $options = array())
	{
		...
		$json->help_popup_mon_espace_civa_ma_ds  = "Vous pouvez saisir votre déclaration de stock : <br /> 1) soit à partir d' une déclaration totalement vierge <br />     2) soit à partir de la déclaration de stock d'une année précédente préremplie <br />     3) soit à partir des données préremplies par les volumes sur place de votre déclaration de récoltes. <br />  Une fois que vous avez commencez à saisir, vous  pouvez à tout moment supprimer la déclaration en cours, et recommencer.";
		...
		$json->stock_aucun_produit  = "La DS n'a aucun produit et n'a pas été signalé comme une DS à néant";    
