...
EOF;
	...
	protected function execute($arguments = array(), $options = array())
	{
		...
		$json->err_log_usages_industriels_pas_volume_sur_place  = "Vous ne pouvez pas déclarer de volume en \"usages industriels saisis\" si vous n'avez pas de \"volume sur place\"";
		$json->err_log_usages_industriels_superieur_volume_sur_place  = "Le volume saisi en \"usages industriels saisi\" ne doit pas être supérieur au \"volume sur place\"";
		...
		$json->err_log_superficie_zero  = "Vous n'avez pas renseigné de détail pour cette appellation";
		...
		$json->intro_mon_espace_civa_dr  = "Vous pouvez interrompre la saisie de votre déclaration à tout moment, vos données seront conservées.";
                $json->intro_mon_espace_civa_dr_date_limite  = "<i>La date limite de souscription de la déclaration de récolte en ligne est fixée règlementairement au <b>10 décembre minuit</b>.</i>";
		...
		$json->intro_mon_espace_civa_ds_non_ouverte  = "Le Téléservice pour la Déclaration de Stocks 2014 sera ouvert à partir du 1er Juillet.";
