...
| Numéro interne du contrat                  | Identifiant          | 123456789                                         | Écriture           | Numéro interne libre devant être unique                                                                                   |
| Numéro du contrat cadre référent           | Identifiant          | 987654321                                         | Écriture           | Numéro interne, Identifiant CIVA ou numéro visa du contrat cadre                                                          |
...
| Acheteur Assujeti TVA                      | Booléeen             | 0 ou 1                                            | Écriture           |                                                                                                                           |
...
| Vendeur Assujeti TVA                       | Booléeen             | 0 ou 1                                            | Écriture           |                                                                                                                           |
...
| Unite prix                                 | Constantes           | €/hl,€/kg,€/ha,€/bouteille                        | Écriture           |                                                                                                                           |
...
| Clause réserve propriété                   | Booléeen             | 0 ou 1                                            | Écriture           | Non utilisé pour les contrats PLURIANNUEL_APPLICATION car repris automatiquement                                          |
...
| Clause de résiliation                      | Texte Multiligne     | Voir dans les annexes                             | Écriture           | Non utilisé pour les contrats PLURIANNUEL_APPLICATION car repris automatiquement                                          |
| Mandat facturation                         | Booléeen             | 0 ou 1                                            | Écriture           | Non utilisé pour les contrats PLURIANNUEL_APPLICATION car repris automatiquement                                          |
| Critères et modalités d’évolution des prix | Texte Multiligne     | Voir dans les annexes                             | Écriture           | Uniquement pour les contrats PLURIANNUEL_CADRE                                                                            |
| Suivi qualitatif                           | Booléeen             | 0 ou 1                                            | Écriture           | Uniquement pour les contrats VIN_VRAC et non utilisé pour les contrats PLURIANNUEL_APPLICATION car repris automatiquement |
| Délai maximum de retiraison                | Texte Simple         | Voir dans les annexes                             | Écriture           | Uniquement pour les contrats MOUT  et non utilisé pour les contrats PLURIANNUEL_APPLICATION car repris automatiquement    |
| Autres clauses particulières               | Texte Multiligne     | Voir dans les annexes                             | Écriture           | Pas utilisé pour les contrats PLURIANNUEL_APPLICATION car repris automatiquement                                          |
| Créateur                                   | Constantes           | ACHETEUR,VENDEUR,COURTIER                         | Lecture seule      | Cette colonne n'a pas besoin d'être présente pour l'import                                                                |
