...
| Campagne                                   | Date au format YYYY-YYYY | 2025-2026                                          | Écriture           | Campagne du contrat ou de début de contrat pour les contrats pluriannuels cadres                                                            |
| Type de contrat                            | Constantes               | [ANNUEL,PLURIANNUEL_CADRE,PLURIANNUEL_APPLICATION] | Écriture           | Un contrat ANNUEL est un contrat spot, un contrat PLURIANNUEL_CADRE est un contrat cadre et un contrat PLURIANNUEL_APPLICATION est un avenant |
...
| Numéro du contrat cadre référent           | Identifiant              | 987654321                                          | Écriture           | Numéro du contrat cadre auquel rattacher le contrat d'application. Uniquement pour les PLURIANNUEL_APPLICATION. Au choix, il est soit le Numéro interne, l'Identifiant CIVA ou le numéro visa du contrat cadre |
...
| Acheteur Nom                               | Texte Simple             | NEGOCE NOM                                         | Écriture           | À titre informatif                                                                                                                          |
...
| Vendeur Nom                                | Texte Simple             | PRODUCTEUR NOM                                     | Écriture           | À titre informatif                                                                                                                          |
...
| Courtier Nom                               | Texte Simple             | Nom du courtier                                    | Écriture           | À titre informatif                                                                                                                          |
...
| Label                                      | Constantes               | [BIO,HVE3]                                         | Écriture           | Peut être vide                                                                                                                              |
...
| Frais annexes vendeur                      | Texte Multiligne         | 5.00€ HT/hl de frais de courtage                   | Écriture           | Facultatif. Possibilité de mettre : "Voir annexe". Non utilisé pour les contrats PLURIANNUEL_APPLICATION car repris automatiquement                                                            |
| Primes diverses acheteur                   | Texte Multiligne         | 5.00€ HT/Hl d'apport global                        | Écriture           | Facultatif. Possibilité de mettre : "Voir annexe". Non utilisé pour les contrats PLURIANNUEL_APPLICATION car repris automatiquement                                                            |
| Clause réserve propriété                   | Booléeen                 | [0,1,NON,OUI]                                      | Écriture           | Facultatif. Possibilité de mettre : "Voir annexe". Non utilisé pour les contrats PLURIANNUEL_APPLICATION car repris automatiquement                                                            |
| Délai paiement                             | Constantes               | [30J,60J]                                          | Écriture           | Facultatif. Possibilité de mettre : "Voir annexe". Non utilisé pour les contrats PLURIANNUEL_APPLICATION car repris automatiquement                                                            |
| Clause de résiliation                      | Texte Multiligne         |                                                    | Écriture           | Facultatif. Possibilité de mettre : "Voir annexe". Non utilisé pour les contrats PLURIANNUEL_APPLICATION car repris automatiquement                                                            |
| Mandat facturation                         | Booléeen                 | [0,1,NON,OUI]                                      | Écriture           | Facultatif. Possibilité de mettre : "Voir annexe". Non utilisé pour les contrats PLURIANNUEL_APPLICATION car repris automatiquement                                                            |
| Critères et modalités d’évolution des prix | Texte Multiligne         |                                                    | Écriture           | Facultatif. Possibilité de mettre : "Voir annexe". Uniquement pour les contrats PLURIANNUEL_CADRE                                                                                              |
| Suivi qualitatif                           | Booléeen                 | [0,1,NON,OUI]                                      | Écriture           | Facultatif. Possibilité de mettre : "Voir annexe". Uniquement pour les contrats VIN_VRAC et non utilisé pour les contrats PLURIANNUEL_APPLICATION car repris automatiquement                   |
| Délai maximum de retiraison                | Texte Simple             |                                                    | Écriture           | Facultatif. Possibilité de mettre : "Voir annexe". Uniquement pour les contrats MOUT  et non utilisé pour les contrats PLURIANNUEL_APPLICATION car repris automatiquement                      |
| Autres clauses particulières               | Texte Multiligne         |                                                    | Écriture           | Facultatif. Possibilité de mettre : "Voir annexe". Pas utilisé pour les contrats PLURIANNUEL_APPLICATION car repris automatiquement                                                            |
...
## Export pour reprise de données

Un fichier d'export peut-être généré avec la liste des contrats cadres à renouveler pour la campagne suivante avec les mêmes colonnes que celui de l'import, augmenté de quelques colonnes supplémentaires décrites ci dessous :

| Nom du champs                              | Type / Format            | Exemple / Liste                                    | Lecture | Commentaire                                                                                                                                 |
|:-------------------------------------------|:-------------------------|:---------------------------------------------------|:-------------------|:--------------------------------------------------------------------------------------------------------------------------------------------|
